...
// Lying with knees bent, torso curled slightly off the floor, both arms
// reaching straight past the head — the "prayer" crunch.
export default function OverheadPrayerCrunchSVG() {
  const hip = [100, 176];
  const knee = [130, 150];
  const foot = [118, 176];
  const toe = [135, 175];
